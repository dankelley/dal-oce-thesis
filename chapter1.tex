\chapter{\label{c:intro}Introduction: this chapter title is very long, so we can see if it ends up single spaced}
...
\section{Test -- this is a very long section title.  Will it be single-spaced in the table of contents?  And how will it look in the document itself?}
